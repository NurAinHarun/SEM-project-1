    ...
    <form action="loginSession.php" method="POST">  
      <div class="form-group">
        <div class="input-group col-xs-15">
          ...
          <input type="text" class="form-control" name="stdName" placeholder="Username" autofocus required/> <!-- need to change this --> 
        </div>
      </div>
      <div class="form-group">
        <div class="input-group col-xs-15">
          <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
          <input type="password" class="form-control" name="stdPwd" placeholder="Password" autofocus required/> <!-- need to change this --> 
        </div>
      </div>
      <div class="btn-group">
